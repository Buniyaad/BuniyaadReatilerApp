...
export default class Pin extends React.Component{
    ...
    check_pin(){
        fetch('https://api.buniyaad.pk/auth/login', {
          ...
          .then(data=> this.setState({data:data.data.checkUser,authenticated:!data.error}))
            ...
            <Container>
                <Content
                 contentContainerStyle={{
                  ...
                  <Text style={styles.labelStyle}>Khush amdeed! baraye meharbaani apni password pin darj karein </Text>
